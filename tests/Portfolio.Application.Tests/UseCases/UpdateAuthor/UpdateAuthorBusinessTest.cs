...
public sealed class UpdateAuthorBusinessTest(PortfolioWebApplicationFactory factory) : BaseAuthTest(factory)
{
    [Fact]
    public async Task Should_UpdateAuthor()
    {
        await AuthenticateAsync();

        UpdateAuthorRequest request = new(
    ...
    [Fact]
    public async Task Should_UpdateAuthor_WithoutChanges()
    {
        await AuthenticateAsync();
    ...
    [Fact]
    public async Task ShouldNot_UpdateAuthor_WithoutAuthentication()
    {
        UpdateAuthorRequest request = new(
            DatabaseFixture.User_1.Email,
            DatabaseFixture.User_1.Password
    ...
    [Fact]
    public async Task ShouldNot_UpdateAuthor_WithAlreadyRegisteredEmail()
    {
        await AuthenticateAsync();
