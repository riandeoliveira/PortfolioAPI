...
namespace AspNetTemplate.Application.Tests.UseCases.FindCurrentUser;

public sealed class FindCurrentUserBusinessTest(AspNetTemplateWebApplicationFactory factory) : BaseAuthTest(factory)
{
    [Fact]
