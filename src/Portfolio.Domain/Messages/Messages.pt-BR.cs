...
public abstract class Messages_PT_BR
{
    ...
    public const string EmailIsNotRegistered = "Este 'e-mail' não está registrado.";
    ...
    public const string InvalidEmail = "O 'e-mail' deve ser válido.";
    public const string InvalidLoginCredentials = "O 'e-mail' ou 'senha' são inválidos.";
