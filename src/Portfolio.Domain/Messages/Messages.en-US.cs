...
public abstract class Messages_EN_US
{
    ...
    public const string AuthorNotFound = "No 'author' found.";
    ...
    public const string EmailIsNotRegistered = "This 'email' is not registered.";
    ...
    public const string InvalidLoginCredentials = "The 'email' or 'password' is invalid.";
